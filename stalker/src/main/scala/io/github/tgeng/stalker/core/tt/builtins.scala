...
object builtins {
  ...
  val levelType = new DefinitionT(parent / "Level")(
  ...
  val universeType = new DefinitionT(parent / "Type")(
  ...
  val lsucFn = new DefinitionT(parent / "lsuc")(
  ...
  val lmaxFn = new DefinitionT(parent / "lmax")(
  ...
  val idType = new DefinitionT(parent / "Id")(
    ...
    Seq(UncheckedClause(
      ...
      UTerm(TWhnf(WId(TWhnf(WVar(2, Nil)), TWhnf(WVar(1, Nil)), TWhnf(WVar(2, Nil))))),
    )),
    null
  )
}